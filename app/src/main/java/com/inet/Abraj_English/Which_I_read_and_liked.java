...
public class Which_I_read_and_liked extends AppCompatActivity   implements Response.Listener<String> ,Response.ErrorListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_which__i_read_and_liked);
    ...
    public void onResponse(String response) {
        try {
            ...
            if(array_data.length()!=0)
            {
                ...
                details_title.setText(object.getString("read_like_en"));
            }
