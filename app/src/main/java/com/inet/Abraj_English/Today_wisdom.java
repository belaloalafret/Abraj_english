...
public class Today_wisdom extends AppCompatActivity  implements Response.Listener<String> ,Response.ErrorListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_today_wisdom);
    ...
    public void onResponse(String response) {
        try {
            ...
            if(array_data.length()!=0)
            {
                ...
                details_title.setText(object.getString("wisdom_en"));
            }
